- To display video on your groundstation (laptop/PC/Tablet etc), you have various options. If you want to just display video, you can use gstreamer by downloading it from the links below.
- You can also use 'Tower Beta' on Android, and a special version of 'Mission Planner' on Windows, see the folders here for the apps
