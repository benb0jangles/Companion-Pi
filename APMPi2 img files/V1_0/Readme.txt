...
# APMpi.img V1_0 by Benbojangles (06/05/2016)
- This .img file is V1 of a project I am working on. It is available under creative Commons License.

- This .img file is a custom raspbian image created for the Raspberry pi 2/3/Zero V1.2/1.3 it includes:
- Raspbian Jessie
- Gstreamer
- Mavproxy
- SSH Enabled
...
- 4)Shutdown pi2 and unplug keyboard/mouse/screen, restart pi
...
- I hope to add more features in future once the groundpi is complete, there will not be a need to setup IP.
